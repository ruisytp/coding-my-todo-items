  ...
  <div class="flex max-w-6xl mx-auto min-h-screen">
    ...
    <div class="w-3/5 pl-4">
      ...
      <div class="bg-white rounded-xl shadow-sm p-5 mb-8">
        <h3 class="text-lg font-semibold text-gray-800 mb-4">新增事项</h3>
        <form @submit.prevent="addNewTodo" class="space-y-4">
          ...
          <button 
            type="submit"
            class="w-full md:w-auto px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium rounded-lg hover:opacity-90 transition-opacity"
          >
            添加待办事项
          </button>
        </form>
      ...
      <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        <h3 class="text-lg font-semibold text-gray-800 p-5 border-b">事项列表</h3>
        <div class="p-5">
